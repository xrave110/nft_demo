...
def write_metadata(token_ids, nft_contract):
    for token_id in range(token_ids):
        ...
        if Path(metadata_file_name).exists():
            ...
            collectible_metadata["attributes"][0]["id"] = token_id
...
def upload_to_ipfs(filepath):
    with Path(filepath).open("rb") as fp:
        ...
        # Result should be like this: https://ipfs.io/ipfs/QmSsYRx3LpDAb1GZQm7zZ1AuHZjfbPkD6J7s9r41xu1mf8?filename=pug.png"
        print(image_uri)
    return image_uri
